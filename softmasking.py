        ...
        for i in range(detections.size(0)):
            ...
            for _ in range(0,5):
                ...
                for o, caps in zip(out, this_captions):
                    ...
                    current_div_set.append(np.expand_dims(o, axis=0))
                    gt_captions.append(caps)
            
            #Diversity within a caption set
            BLEUScores = selfBLEU(current_div_set, text_field)
            diversity_scores.append(BLEUScores)
...
print("Diversity scores BLEU 1, 2, 3, 4")
print(np.mean(diversity_scores, axis = 0))
